...
import { HomeIcon, BookOpenIcon, ShoppingCartIcon, BookmarkIcon, UserIcon, ArrowRightEndOnRectangleIcon, GlobeAltIcon, Bars3Icon, XMarkIcon } from '@heroicons/react/24/outline';
      ...
      >
        ...
        <div className="flex gap-6 items-center">
          ...
          {user ? (
            <NavLink
              to="/profile"
              className="flex flex-col items-center group relative text-[#2B2C2D] ml-4 transition-colors duration-200 hover:text-[#B58B5C]"
            >
              <UserIcon className="h-6 w-6 transition-transform duration-200 group-hover:-translate-y-1" />
              <span className="absolute -bottom-6 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-200 font-semibold">
                Profil
              </span>
            </NavLink>
            ...
            <NavLink
              ...
              className="flex flex-col items-center group relative text-[#2B2C2D] ml-4 transition-colors duration-200 hover:text-[#B58B5C]"
            >
              <ArrowRightEndOnRectangleIcon className="h-6 w-6 transition-transform duration-200 group-hover:-translate-y-1" />
              <span className="absolute -bottom-6 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-200 font-semibold">
                Masuk
              </span>
            </NavLink>
          ...
          <div className="flex flex-col gap-6">
            ...
            {user ? (
              <NavLink
                to="/profile"
                onClick={() => setIsSidebarOpen(false)}
                className="flex items-center gap-4 text-lg font-semibold px-4 py-2 rounded-lg transition-colors duration-200 text-[#2B2C2D] hover:bg-gray-200"
              >
