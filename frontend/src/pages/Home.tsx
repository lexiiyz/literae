...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      setLoading(true);
      try {
        const [best, classics, newArrivals, curated] =
          await Promise.all([
